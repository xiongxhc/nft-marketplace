								...
								<div className="col-lg-6 col-md-6">
									<div className="blog-card box-shadow">
										...
										<div className="content">
											<h3>
												<a href="blog-details.html">
													Christie’s Ended Up Selling
													For $69 Million In Nft
													Marketplace
												</a>
											</h3>
											<ul>
								...
								<div className="col-lg-6 col-md-6">
									<div className="blog-card box-shadow">
										...
										<div className="content">
											<h3>
												<a href="blog-details.html">
													Artist Interview: Arran
													Schonberg (Divergence_art)
												</a>
											</h3>
											<ul>
												<li>June 11, 2021</li>
								...
								<div className="col-lg-6 col-md-6">
									<div className="blog-card box-shadow">
										...
										<div className="content">
											<h3>
												<a href="blog-details.html">
													The Biggest Drop In Times
													Square Since New Years Eve
												</a>
											</h3>
											<ul>
												<li>June 15, 2021</li>
							...
							<div className="side-bar-area pl-20">
								...
								<div className="widget-popular-post">
									...
									<article className="item">
										...
										>
											<span
												className="full-image cover bg1"
												role="img"
											></span>
										</a>
										<div className="info">
