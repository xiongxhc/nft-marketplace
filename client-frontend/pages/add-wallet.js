				...
				<div className="container">
					<div className="section-title">
						...
						<p>
							...
							create a new wallet.{" "}
							<a href="help-center.html">What is a wallet?</a>{" "}
						</p>
					</div>
					...
					<div className="row pt-45">
						<div className="col-lg-4 col-6">
							<div className="wallet-card">
								<img
									src="../images/wallet-img/wallet-img1.png"
									alt="Images"
								/>
								<h3>
									<a href="contact.html">Torsol</a>
								</h3>
								<p>
									Connect with your google, facebook, twitter
									or discord all social media
								</p>
						...
						<div className="col-lg-4 col-6">
							<div className="wallet-card">
								<img
									src="../images/wallet-img/wallet-img2.png"
									alt="Images"
								/>
								<h3>
						...
						<div className="col-lg-4 col-6">
							<div className="wallet-card">
								<img
									src="../images/wallet-img/wallet-img3.png"
									alt="Images"
								/>
								<h3>
						...
						<div className="col-lg-4 col-6">
							<div className="wallet-card">
								<img
									src="../images/wallet-img/wallet-img4.png"
									alt="Images"
								/>
								<h3>
						...
						<div className="col-lg-4 col-6">
							<div className="wallet-card">
								<img
									src="../images/wallet-img/wallet-img5.png"
									alt="Images"
								/>
								<h3>
						...
						<div className="col-lg-4 col-6">
							<div className="wallet-card">
								<img
									src="../images/wallet-img/wallet-img6.png"
									alt="Images"
								/>
								<h3>
